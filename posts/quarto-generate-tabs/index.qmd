...
When working with a list of outputs, it may be useful to organize the outputs into tabs instead of a huge list of individual outputs.
...
The list of outputs can be called and presented as below
