...
We next subset the data for the observations foudn in Los Angeles, CA. The longitude and latitude are then used to plot the locations on a map using the leaflet library. The 'J.F.K. Library Third' location is removed from the data as it is an outlier and is not located in Los Angeles, CA.
